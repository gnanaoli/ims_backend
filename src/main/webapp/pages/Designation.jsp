								...
								<form class="form-inline"  method="post" name="addDesignation" novalidate>
									<div class="col-md-6 col_md text-center">
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="designation" maxlength="100" allowspacealphanumdesgination name="designation" data-ng-model="DesignationDto.designation"  autocomplete="off"tabindex="1" required="required">
