...
<link rel="stylesheet" href="resources/css/amchart-export.css"
					...
					<security:authorize
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="#"
									ng-click="showUserProjectChart=!showUserProjectChart">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(187, 120, 36, 0.1)">
										<center>
											<i class="fa fa-area-chart" style="color: #BB7824"></i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
											Inventory Count
											<div class="pull-right badge badge-primary">{{totaluserProject}}</div>
										</h4>
									</div>
								</a>
							</div>
							...
							<div class="wrimagecard wrimagecard-topimage">
								<a href="common?link=ServiceDueDate">
									<div class="wrimagecard-topimage_header"
										...
										<center>
											<i class="fa fa-clock-o" style="color: #16A085"></i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="common?link=ProjectManagement">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(213, 15, 37, 0.1)">
										<center>
											<i class="fa fa-pencil-square-o" style="color: #d50f25">
											</i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="common?link=ElcbStatus">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-table" style="color: #3369e8"> </i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="common?link=ServiceInspection">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-wrench" style="color: #3369e8"> </i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
											Service Request
											<div class="pull-right badge badge-primary" id="WrForms">{{serviceApprovedCount}}</div>
										</h4>
									</div>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="common?link=ScrapInspection">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-recycle" style="color: #3369e8"> </i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
											Scrap Inspection
											<div class="pull-right badge badge-primary" id="WrForms">{{scrapApprovedCount}}</div>
										</h4>
									</div>
						...
						<div class="col-md-12 row">
							<div class="col-md-6" ng-hide="showUserProjectChart">
								<p class="text-center">Inventory Count</p>
								<div id="inventoryCount3DBarChartForUser"></div>
							</div>
							<div class="col-md-6" ng-hide="showUserProjectChart">
								<p class="text-center">Inventory Count</p>
								<div id="RoundChartForSpecificUserProject"
				...
				<div class="">
					<security:authorize access="hasAuthority('SAFETY ENGINEER')">
						...
						<p style="font-weight: 400;">
							<span style="color: red;">Note : </span>User involved in the
							following Projects <b ng-repeat="x in userProject">{{x.name}}{{$last
								? '' : ', '}}</b>. <br>The grid showing only the updated ELCB
							Date, remaining other Projects are not updated in the system.
						</p>
				...
				<div class="row">
					<security:authorize access="hasAuthority('OFFICE ADMINISTRATOR')">
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="#"
									ng-click="showOfficeWarehouseChart=!showOfficeWarehouseChart">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(187, 120, 36, 0.1)">
										<center>
											<i class="fa fa-area-chart" style="color: #BB7824"></i>
									...
									<div class="wrimagecard-topimage_title">
										<h4>
											WareHouse Inventory
											<div class="pull-right badge badge-primary">{{totalWareHouseOffice}}</div>
										</h4>
									</div>
								</a>
							</div>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="#"
									ng-click="showOfficeProjectChart=!showOfficeProjectChart">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(22, 160, 133, 0.1)">
										<center>
									...
									<div class="wrimagecard-topimage_title">
										<h4>
											Projects Inventory
											<div class="pull-right badge badge-primary" id="WrControls">{{totalProjects}}</div>
										</h4>
									</div>
								</a>
							</div>
							...
							<div class="wrimagecard wrimagecard-topimage">
								<a href="officeAdmin?link=ServiceDueDate">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(213, 15, 37, 0.1)">
										<center>
											<i class="fa fa-clock-o" style="color: #d50f25"> </i>
										</center>
									</div>
									<div class="wrimagecard-topimage_title">
										<h4>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="officeAdmin?link=ServiceInspection">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-wrench" style="color: #3369e8"> </i>
									...
									<div class="wrimagecard-topimage_title">
										<h4>
											Service Request
											<div class="pull-right badge badge-primary" id="WrForms">{{serviceInspectionCount}}</div>
										</h4>
									</div>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="officeAdmin?link=ScrapInspection">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-recycle" style="color: #3369e8"> </i>
									...
									<div class="wrimagecard-topimage_title">
										<h4>
											Scrap Inspection
											<div class="pull-right badge badge-primary" id="WrForms">{{scrapInspectionCount}}</div>
										</h4>
									</div>
						...
						<div class="col-md-12 row">
							...
							<p class="text-center">WareHouse Inventory Count</p>
								<div id="inventoryCount3DBarChartForOfficeAdministrator"></div>
							</div>
							<div class="col-md-6" ng-hide="showOfficeProjectChart">
							<p class="text-center">Project Count</p>
								<div id="RoundChartForOfficeAdministrator"
									style="height: 300px; width: 100%;"></div>
							</div>
						</div>
					</security:authorize>
			...
			<div class="col-md-12">
				<div class="row">
					<security:authorize
							...
							<div class="wrimagecard wrimagecard-topimage">
								<a href="#" ng-click="showWarehouseChart=!showWarehouseChart">
									...
									<div class="wrimagecard-topimage_title">
										<h4>
											Inventory Count
											<div class="pull-right badge badge-primary">{{totalWarehouse}}</div>
										</h4>
									</div>
								</a>
							</div>
						...
						<div class="col-md-3">
							<div class="wrimagecard wrimagecard-topimage">
								<a href="wareHouseAdmin?link=Notification">
									<div class="wrimagecard-topimage_header"
										style="background-color: rgba(51, 105, 232, 0.1)">
										<center>
											<i class="fa fa-table" style="color: #3369e8"> </i>
						...
						<div class="col-md-12 row">
							...
							<div class="col-md-6" ng-hide="showWarehouseChart">
								<p class="text-center">Inventory Count</p>
								<div id="RoundChartForSpecificWareHouseAdministrator"
									style="height: 300px; width: 100%;"></div>
							</div>
						</div>
					</security:authorize>
