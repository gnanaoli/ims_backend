	...
	<div class="form_section">
		<div class="form-content create_form">
			...
			<div data-ng-show="viewAssignableTools">
				...
				<form class="form-inline" role="form" name="assign_tools"
					id="assign_tools" novalidate
					data-ng-show="inventoryManagementMaster.length>0">

					<div class="col-md-4 add_icon_asterisk">
						...
						<div
							data-ng-show="assign_tools.$submitted || assign_tools.category_type.$touched"
							class="error_msg">
							<div data-ng-show="assign_tools.category_type.$error.required"
								class="error_msg1">Please Select Category type</div>
						</div>
					...
					<div class="col-md-4 add_icon_asterisk">
						...
						<div class="new-select-option">
							<select name="sub_category" id="sub_category"
								data-ng-model="assignInventoryDto.subCategory" required
						...
						<i class="fa fa-asterisk"></i>
						<div
							data-ng-show="assign_tools.$submitted || assign_tools.sub_category.$touched"
							class="error_msg">
							<div data-ng-show="assign_tools.sub_category.$error.required"
								class="error_msg1">Please Select SubCategory</div>
						</div>
					...
					<div class="col-md-1 text-center">
						...
						<button class="btn btn-primary" id=""
							data-ng-click="search(assignInventoryDto)">
			...
			<div class="text-center"
				data-ng-if="assignInventoryManagementDtoList.length == 0 && showMsg">
				<br> <br> <strong><b>{{alertMsg}}</b></strong>
			</div>
			...
			<div data-ng-show="viewAssignableTools">
				...
				<div class="table-responsive"
					data-ng-if="assignInventoryManagementDtoList.length > 0">
					<table datatable="ng" dt-options="dtOptions"
						...
						<tbody>
							<security:authorize
								...
								<tr
									data-ng-repeat="inventoryManagementDto in assignInventoryManagementDtoList">
									<td>
										<div class="new-check-button">
											<input type="checkbox" name="projectName"
												id="{{inventoryManagementDto.id}}"
												data-ng-model="inventoryManagementDto.selected"
												class="filled-in"
												data-ng-change="removeUnchecked(inventoryManagementDto.selected,inventoryManagementDto.id)" />
									...
									<td><input type="text" value=""
										data-ng-model="inventoryManagementDto.allocatableQuantity"
										size="5" numbersonly maxlength="10"
										data-ng-blur="checkAssignableQuantity(inventoryManagementDto.id,inventoryManagementDto.availableQuantity,inventoryManagementDto.allocatableQuantity)" /></td>
								</tr>
							</security:authorize>
						</tbody>
					</table>
			...
			<div class="col-md-12" data-ng-show="viewAssign">
				...
				<div class="col-12 submit_col text-center">
					<button class="btn btn-primary" data-ng-click="assignTools()">
			...
			<div data-ng-show="viewAssignForm">
				<form class="form-inline" role="form"
					name="assignInventoryForDispatch" id="assignInventoryForDispatch"
					novalidate>
					<div class="row">
						...
						<div class="col-md-6 add_icon_asterisk">
							...
							<div class="new-select-option assign_tools_input">
								<select name="project" id="project"
									data-ng-model="inventoryManagementDto.projectName" required
									class="select2 form-control" style="width: 100%; height: 36px;">
									<option value="" selected></option>
									<option
							...
							<div
								data-ng-show="assignInventoryForDispatch.$submitted || assignInventoryForDispatch.project.$touched"
								class="error_msg">
								<div
									data-ng-show="assignInventoryForDispatch.project.$error.required"
					...
					<div class="col-12 submit_col text-center">
						<button class="btn btn-primary" data-ng-if="showSendBtn"
							data-ng-click="addInventoryInDispatch()">
							<i class="fa fa-check"></i> SEND
						</button>
						<button class="btn btn-primary" data-ng-click="cancelAssign1()">
