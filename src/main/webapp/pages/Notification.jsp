	...
	<div class="form_section">
		...
		<div class="form-content">
			...
			<div class="table-responsive"
				data-ng-if="notificationDtoList.length>0">
					...
					<tbody>
						...
						<security:authorize
							...
							<tr data-ng-repeat="notificationDto in notificationDtoList">
								<td>{{notificationDto.requestedTo}}
									{{notificationDto.status}} {{notificationDto.categoryType}}
									{{notificationDto.quantity}} Qty From
									{{notificationDto.requestedFrom}}</td>
			...
			<div class="text-center" data-ng-if="notificationDtoList.length == 0">
				<br>
				<br>
