						...
						<tbody>
							...
							<tr data-ng-repeat="serviceDto in serviceTrackerList">
								...
								<td class="table_btn_group"
									data-ng-if="serviceDto.status == 'ACTIVE' || serviceDto.status == 'PARTIALLY DISPATCHED'"><a
									href="" data-ng-click="receive(serviceDto)"
					...
					<div class="col-md-6 col_md text-center">
						...
						<div class="">
							<label for="pwd"> Available Quantity :</label> <input type="text"
								...
								data-ng-model="serviceDto.quantity" numbersonly readonly
								autocomplete="off" tabindex="4" autofocus required>
						</div>
						...
						<div class="">
							<label for="pwd"> Quantity:</label> <input type="text"
								...
								required="required"
								data-ng-model="serviceDto.availableQty" numbersonly
								autocomplete="off" tabindex="4" autofocus>
						</div>
						...
						<div
							...
							<div class="error_msg"
								...
								Please Enter Available Quantity</div>
