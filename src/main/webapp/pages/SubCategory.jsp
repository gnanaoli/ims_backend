				...
				<table datatable="ng" dt-options="dtOptions"
					...
					<tbody>
						<tr data-ng-repeat="subCategoryDto in subCategoryDtoList">
							...
							<security:authorize access="hasAuthority('OFFICE ADMINISTRATOR')"><a href="" class="btn btn-primary" data-ng-click="edit(subCategoryDto)"><i class="fa fa-edit"></i> Edit</a>
							</security:authorize>
								...
								<form class="form-inline" method="post" role="form" name="new_subcategory" id="new_category" novalidate>
										   ...
										   <div class="new-select-option">
                                             ...
                                             required class="select2 form-control" tabindex="1"
                                              style="width: 100%; height: 36px;" required>
                                                <option></option>
                                                <option data-ng-repeat="x in categoryMasterDtoList track by x.categoryType" data-ng-if="x.status == 'ACTIVE'"
                                                value="{{x.categoryType}}">{{x.categoryType}}</option>
									...
									<div data-ng-show="new_subcategory.categoryType.$error.required" class="error_msg">Please Select  Category Type</div>
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="subCategory" name="subCategory" maxlength="100" subcategoryvalid data-ng-model="subCategoryDto.subCategory" required>
											<i class="fa fa-asterisk" ></i>
									...
									<div data-ng-show="new_subcategory.subCategory.$error.required" class="error_msg">Please Enter Sub Category </div>
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="model" name="model" alphamumeric data-ng-model="subCategoryDto.model" maxlength="10" required>
											<i class="fa fa-asterisk" ></i>
										</div>
									...
									<div data-ng-show="new_subcategory.model.$error.required" class="error_msg">Please Enter Model </div>
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="hsnCode" name="hsnCode" alphamumeric data-ng-model="subCategoryDto.hsnCode" maxlength="20" required>
											<i class="fa fa-asterisk" ></i>
										</div>
									...
									<div class="new-radio-button-inline add_icon_asterisk">
							...
							<div class="form-content create_form">
								...
								<form class="form-inline"  method="post" role="form" name="addsubcategory" id="addsubcategory" novalidate >
									...
									<div data-ng-show="addsubcategory.categoryType.$error.required" class="error_msg">Please Select  Category Type</div>
										...
										<div class="add_icon_asterisk">
											<label for="pwd"> Sub Category:</label>
											<input type="text" class="form-control" id="subCategory" name="subCategory" subcategoryvalid maxlength="100" data-ng-model="subCategoryDto.subCategory" required="required" autocomplete="off" tabindex="2" >
											<i class="fa fa-asterisk" ></i>
										</div>
									...
									<div data-ng-show="addsubcategory.subCategory.$error.required" class="error_msg">Please Enter Sub Category </div>
										...
										<div class="add_icon_asterisk">
											<label for="pwd"> Model Code:</label>
											<input type="text" class="form-control" id="model" name="model" alphamumeric data-ng-model="subCategoryDto.model" maxlength="10" required="required" autocomplete="off" tabindex="3">
											<i class="fa fa-asterisk" ></i>
										</div>
									...
									<div data-ng-show="addsubcategory.model.$error.required" class="error_msg">Please Enter Model </div>
										...
										<div class="add_icon_asterisk">
											<label for="pwd"> HSN Code:</label>
											<input type="text" class="form-control" id="hsnCode" name="hsnCode" alphamumeric data-ng-model="subCategoryDto.hsnCode" maxlength="20" required="required" autocomplete="off"  tabindex="4">
											<i class="fa fa-asterisk" ></i>
										</div>
