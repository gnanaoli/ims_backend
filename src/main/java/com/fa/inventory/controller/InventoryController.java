...
public class InventoryController {
	...
	public ResponseEntity<ResponseDto> getAllUsers(HttpServletRequest request, HttpServletResponse response,
	...
	public List<SupplierDto> viewAllSuppliers(HttpServletRequest request, HttpServletResponse response)
		...
		// return new ResponseEntity<List<SupplierDto>>(supplierDto,
		// HttpStatus.OK);
		return supplierDto;
	...
	@ResponseBody
	public List<ScrapDto> getAllWarehouseScrap(HttpServletRequest request, HttpServletResponse response,
	...
	@ResponseBody
	public ModelAndView edit_scrap(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView EditScrap(@RequestBody ScrapDto scrapDto, HttpServletRequest request,
	...
	public ResponseEntity<ResponseDto> saveBulkRequest(@RequestBody List<CategoryDto> categoryDto,
			Principal principal) {
		ResponseDto responseDto = new ResponseDto();
		try {
	...
	public ResponseEntity<List<MenuDto>> getCurrentUserpages(HttpServletRequest request, HttpServletResponse response,
			Principal principal) {
	 ...
	 * String logoutDo(HttpServletRequest request,HttpServletResponse response){
	 * HttpSession session= request.getSession(false);
	 * SecurityContextHolder.clearContext(); logger.info(
	 * "<--inventoryController-------------logout--------------------started-->"
	 * ); session= request.getSession(false); if(session != null) {
	 * session.invalidate(); } for(Cookie cookie : request.getCookies()) {
	 * cookie.setMaxAge(0); } logger.info(
	 * "<--inventoryController-------------logout--------------------started-->"
	 * ); return "logout"; }
	 */
	...
	public ResponseEntity<UserDto> getProfileDetails(Principal principal) {
		...
		try {
			...
			// model.addObject("inventoryManagementDtoList",
			// inventoryManagementDtoList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ResponseEntity<ResponseDto> saveSubCategory(@RequestBody SubCategoryDto subCategoryDto,
			Principal principal) {
	...
	public ResponseEntity<ResponseDto> saveBlock(@RequestBody WareHouseBlocksDto wareHouseBlocksDto,
			Principal principal) {
	...
	public ResponseEntity<ResponseDto> saveWorksMenDetails(@RequestBody List<WorksMenDetailsDto> worksMenDetailsDtolist,
			Principal principal) {
	...
	public ResponseEntity<ResponseDto> saveWorksMenCategory(@RequestBody WorksMenCategoryDto worksMenCategoryDto,
			Principal principal) {
	...
	public ModelAndView officeAdminMapping(@RequestParam("link") String link, HttpServletRequest request,
			HttpServletResponse response, Principal principal) {
		ModelAndView model = null;
	...
	public ModelAndView wareHouseAdminMapping(@RequestParam("link") String link, HttpServletRequest request,
			HttpServletResponse response, Principal principal) {
		ModelAndView model = null;
	...
	public ModelAndView commonUserMapping(@RequestParam("link") String link, HttpServletRequest request,
			HttpServletResponse response, Principal principal) {
		ModelAndView model = null;
	...
	public ResponseEntity<ResponseDto> approveInspection(@RequestBody InventoryRequestDto requestDto,
			Principal principal) {
	...
	public ResponseEntity<ResponseDto> verifyInspection(@RequestBody InventoryRequestDto requestDto,
			Principal principal) {
	...
	public ResponseEntity<ResponseDto> VerifyandApproveScrapInspection(
			@RequestBody ScrapInspectionDto scrapInspectionDto, Principal principal) {
		...
		try {
			...
			System.out
					.println("VerifyandApproveScrapInspection==>" + new ObjectMapper().writeValueAsString(responseDto));
		} catch (Exception e) {
			responseDto.setExceptionMessage(e.getMessage());
			e.printStackTrace();
		}
	...
	public ResponseEntity<ResponseDto> VerifyandApproveServiceInspection(
			@RequestBody ServiceInspectionDto serviceInspectionDto, Principal principal) {

		logger.info(
				"<--inventoryController-------------VerifyandApproveServiceInspection--------------------started-->");
		ResponseDto responseDto = new ResponseDto();
		String status = null;
		try {
			...
			System.out.println(
					"VerifyandApproveServiceInspection==>" + new ObjectMapper().writeValueAsString(responseDto));
		} catch (Exception e) {
			responseDto.setExceptionMessage(e.getMessage());
			e.printStackTrace();
		}
	...
	public ResponseEntity<ResponseDto> saveUserTheme(@RequestBody UserDto userDto, Principal principal,
			HttpSession session) {
	...
	public ResponseEntity<ResponseDto> getLastOneMonthOfficeElcbStatus(Principal principal) {
		...
		try {
			...
			responseDto.setResponseDtoList(elcbDtoList);
			System.out.println(
					"getLastOneMonthOfficceElcbStatus==>" + new ObjectMapper().writeValueAsString(responseDto));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@RequestMapping(value = "/receiveServiceTools", method = RequestMethod.POST)
	public ResponseEntity<ResponseDto> receiveServiceTools(@RequestBody ServiceTrackerDto serviceTrackerDto,
			Principal principal, HttpSession session) {

		logger.info("<--inventoryController-------------receiveServiceTools--------------------started-->");
		ResponseDto responseDto = new ResponseDto();
		try {
			responseDto = serviceInpectionService.receiveServiceTools(serviceTrackerDto, principal, session);
			responseDto.setStatus(InventoryConstant.SUCCESS);
			System.out.println("receiveServiceTools==>" + new ObjectMapper().writeValueAsString(responseDto));
		} catch (Exception e) {
			responseDto.setExceptionMessage(e.getMessage());
			e.printStackTrace();
		}
		logger.info("<--inventoryController-------------receiveServiceTools--------------------Ended-->");
		return new ResponseEntity<ResponseDto>(responseDto, HttpStatus.OK);
	}

	/** getAllServiceTracker **/

	@RequestMapping(value = "/getAllServiceTracker", method = RequestMethod.GET)
	public ResponseEntity<ResponseDto> getAllServiceTracker(Principal principal, HttpSession session) {

		logger.info("<--inventoryController-------------getAllServiceTracker--------------------started-->");
		ResponseDto responseDto = new ResponseDto();
		try {
			responseDto = serviceTrackerService.getAllServiceTracker(principal, session);
			responseDto.setStatus(InventoryConstant.SUCCESS);
			System.out.println("getAllServiceTracker==>" + new ObjectMapper().writeValueAsString(responseDto));
		} catch (Exception e) {
			responseDto.setExceptionMessage(e.getMessage());
			e.printStackTrace();
		}
		logger.info("<--inventoryController-------------getAllServiceTracker--------------------Ended-->");
		return new ResponseEntity<ResponseDto>(responseDto, HttpStatus.OK);
	}
