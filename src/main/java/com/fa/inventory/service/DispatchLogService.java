...
public interface DispatchLogService {
	...
	ResponseDto acceptInventoryByChallaNo(BulkRequestResponseDto bulkRequestResponseDto,Principal principal) throws Exception;

	DispatcherLogDto mapDispatcherLogDto(DispatcherLog dispatcherLog);
