...
public interface ToolsRequestService {
	...
	// String saveToolsRequest(InventoryEntranceDto inventoryEntranceDto,
	// Principal principal);

	// String saveToolsRequest(InventoryRequestDto InventoryRequestDto,
	// Principal principal);

	ResponseDto saveToolsRequest(InventoryRequestDto inventoryRequestDto, Principal principal);
	...
	ResponseDto saveAcceptToolsRequest(InventoryRequestDto inventoryRequestDto, Principal principal) throws Exception;

	// String saveMoveTools(InventoryRequestDto inventoryRequestDto, Principal
	// principal)throws Exception;

	// String saveAcceptToolsRequest(InventoryRequestDto inventoryRequestDto,
