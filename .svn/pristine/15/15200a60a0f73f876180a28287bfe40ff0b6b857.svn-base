...
<div class="">
						<label for="pwd">Date:</label> <input type="text"
							...
							data-ng-model="WorksmenDto.date"  readonly tabindex="1">
					</div>
				...
				<div class="col-md-6 col_md text-center">
                    <div class="add_icon_asterisk">
						<label for="pwd"> Resource Count:</label> <input type="text"
							...
							data-ng-model="WorksmenDto.resourceCount" ng-init="WorksmenDto.resourceCount=''" data-ng-change="validate()" numberswithdecimalexampl data-ng-pattern="/^(?!^0*$)(?!^0*\.0*$)^\d{1,18}(\.\d{1})?$/"  autocomplete="off" tabindex="4" maxlength="10" required>
							<i class="fa fa-asterisk" ></i>
					</div>
					...
					<div
						...
						<div data-ng-show="addWorksmen.resourceCount.$error.required"
							...
							<div
											data-ng-show="addWorksmen.resourceCount.$error.pattern"
											class="error_msg">Please Enter Valid Resource Count
									</div>
					</div>
					...
					<div
						...
						<div data-ng-show="addWorksmen.comments.$error.required"
                           ...
                           <div class="col-12 submit_col text-right"     style="margin-top: 22px">
					           <button class="btn btn-primary" type="submit" tabindex="6" >
						         <i class="fa fa-check"></i> ADD
					    </button>
					     <span class="btn btn-warning" data-ng-click="back()" tabindex="7" style="margin-right:18%" >
