								...
								<form class="form-inline"  method="post" name="addDesignation" novalidate>
									<div class="col-md-6 col_md text-center">
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="designation" allowspacealphanumdesgination name="designation" data-ng-model="DesignationDto.designation" maxlength="45" required>
