...
<body>
        <div class="limiter">
                <div class="container-login100">
                        <div class="wrap-login100">
                                <div class="login100-pic js-tilt">
                                        <img src="resources/img1/spanengineers-logo.png" alt="LOGO">
                                </div>
                                <form class="login100-form validate-form" action="<c:url value='/'/>" method="post"  name="login_form" id="login_form" >
                                        <span class="login100-form-title">
                                        </span>
                                        <p style="color:red" class="text-center"><b>${error}</b></p><br>
                                        ...
                                        <div class="wrap-input100 validate-input" data-validate="Password is required" class="error_msg">
                                                <input class="input100" type="password" id="pwd" name="password" placeholder="Password" required>
                                                <span class="focus-input100"></span>
                                                <span class="symbol-input100">
                                        ...
                                        <div class="text-center p-t-12">
                                                ...
                                                <a class="txt2" href="ForgotPassword" id="">
                                                        Forgot Password?
                                                </a>
                                        </div>
                                </form>
                ...
                <div class="container-login100 " id="forget-pass" data-ng-controller="ForgotPassword" >
                        <div class="wrap-login100">
                                <!-- <div class="login100-pic js-tilt" data-tilt>
                                        <img src="img/logo.png" alt="LOGO">
                                </div> -->
                                <form class="login100-form validate-form" name="frgmyform" novalidate>
                                        <button type="button" class="forget-close">
                                        ...
                                        <div class="wrap-input100 validate-input">
                                                <input class="input100" type="text" name="userId" data-ng-model="userDto.userId" placeholder="Username" required>
                                                <span class="focus-input100"></span>
                                                <span class="symbol-input100">
                                                        <i class="fa fa-user " aria-hidden="true"></i>
                                                </span>
