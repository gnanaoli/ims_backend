		...
		<div data-ng-show="editState">
					...
					<div class="form_section">
							<div class="form-content create_form">
								<h4 class="form_content_title">Edit State</h4>
...
<!-- 					</div>										 -->
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="statecode" alphamumeric name="statecode" maxlength="3" data-ng-model="stateDto.stateCode" required autocomplete="off" tabindex="1" readonly>
					...
					<div data-ng-show="addstate.$submitted || addstate.statecode.$touched" class="error_msg">					
						<div data-ng-show="addstate.statecode.$error.required" class="error_msg">Please Enter StateCode </div>
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="state" name="state" allowspace data-ng-model="stateDto.stateName" required maxlength="50" autocomplete="off" tabindex="2" readonly >
											<i class="fa fa-asterisk" ></i>
										</div>	
