...
/*	@Column(name = "fax_1", length = 50)
	...
	@Column(name = "india_outside", length = 50)
	private String indiaOrOutside;
	
	@Column(name="alternative_email_id",length=90)
	...
	@Column(name="additional_address2",length=100)
    private String additionalAddress2;
	
	@Column(name="additional_address3",length=100)
    private String additionalAddress3;
	
	@Column(name="toll_free_no",length=100)
	...
	public String getIndiaOrOutside() {
		return indiaOrOutside;
	}

	public void setIndiaOrOutside(String indiaOrOutside) {
		this.indiaOrOutside = indiaOrOutside;
	}
