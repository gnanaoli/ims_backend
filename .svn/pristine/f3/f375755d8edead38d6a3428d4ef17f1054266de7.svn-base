...
<body>
	<div class="limiter">
		<div class="container-login100" id="forgotpass" data-ng-controller="UserActiveController">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" name="frgmyform" novalidate>
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="userId" id="userId" data-ng-model="userDto.userId" data-ng-init=userDto.userId='<security:authentication property="principal"/>' readonly required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user " aria-hidden="true"></i>
						</span>
					</div>
								  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.userId.$touched" class="error_msg">
...
<!-- 						</select> -->
			  	...
			  	<div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.selectedQuestions.$touched" class="error_msg">
					...
					<div class="wrap-input100 validate-input" data-validate="Secret Answer is required" class="error_msg">
						<input class="input100" type="text" name="secretanswer" id="secretanswer" alphamumeric data-ng-model='userDto.secretanswer' required placeholder="Secret Answer">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
			  ...
			  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.secretanswer.$touched" class="error_msg">
					...
					<div class="wrap-input100 validate-input tooltip_codition" data-validate="Password is required" class="error_msg">
						<input class="input100 input_condition" type="password" name="newPassword" id="newPassword" disallowSpaces data-ng-model='userDto.newPassword' required placeholder="New Password" maxlength="{{passwordRulesDto.minLengthForRegularPassword}}">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
			  ...
			  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.newPassword.$touched" class="error_msg">
					...
					<div class="wrap-input100 validate-input tooltip_codition" data-validate="Password is required" class="error_msg">
						<input class="input100 input_condition" type="password" name="confirmPassword" id="confirmPassword" disallowSpaces data-ng-model='userDto.confirmPassword' required placeholder=" Confirm Password" maxlength="{{passwordRulesDto.minLengthForRegularPassword}}">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
			  ...
			  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.confirmPassword.$touched" class="error_msg">
                     ...
                     <span ng-show = "userDto.confirmPassword.toString() != userDto.newPassword.toString()" class="error_msg">Password Does Not Match</span>
                </div>					
