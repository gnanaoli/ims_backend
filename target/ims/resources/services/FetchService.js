ims.factory('FetchService',function($http,$q,UrlConstants) {
	...
	return {
        ...
        getAllServiceTracker : getAllServiceTracker,
        getAllInventoryUserCount : getAllInventoryUserCount,
...
//					console.log("SupplierList"+JSON.stringify(response.data));
	...
	function getAllInventoryUserCount() {
		var deferred = $q.defer();
		$http({
			method : 'GET',
			url : UrlConstants.GETALLINVENTORYUSERCOUNT,		
			headers : {
				'Content-Type' : 'application/json'
			}
		})
...
// console.log(response);
	...
	function getAllNotificationDetails() {
		...
		$http({
			method : 'GET',
			url : UrlConstants.GETALLNOTIFICATIONDETAILS,
			headers : {
				'Content-Type' : 'application/json'
			}
		})
...
/* FOR THE PROJECT WHICH ARE MAPPED TO THE PARTICULAR LOGED USER */
	...
	/*
	 * FOR THE PROJECT WHICH ARE MAPPED TO THE PARTICULAR LOGED USER AND THE
	 * PROJECT NOT BE CLOSED
	 */
...
// console.log("notification data==>"+JSON.stringify(response.data));
	...
	function getAllServiceTracker() {
		...
		$http({
			method : 'GET',
			url : UrlConstants.GETALLSERVICETRACKER,
			headers : {
				'Content-Type' : 'application/json'
			}
		})
		.then(
				function successCallback(response) {
					//console.log("GETALLSERVICETRACKER"+JSON.stringify(response.data));
					deferred.resolve(response.data);
				},
				function errorCallback(response) {
					console.log(response);
