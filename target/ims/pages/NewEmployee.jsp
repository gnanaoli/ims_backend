...
<!-- Container fluid  -->
<!-- ============================================================== -->
<div class="container-fluid user-top" data-ng-controller="employeeManagementController">
	<!-- ============================================================== -->
	...
	<div class="form_section">
                    <div class="form-content create_form">
						...
						<div data-ng-show="Employee.firstName.$error.required" class="error_msg1">Please
							Enter First Name</div>
                                ...
                                <div class="three_column_form_column">
                                    ...
                                    <input type="text"
							class="form-control" id="lastName" name="lastName" namespacewithdot
							...
							Enter Name</div>
                                ...
                                <div class="three_column_form_column">
					              ...
					              <div class="input-group date" data-date-format="dd/mm/yyyy" data-date-autoclose="true"  data-date-end-date="0d" data-provide="datepicker">
                                   ...
                                   <input type="text" class="form-control" placeholder="" name="dateOfBirth" data-ng-model="employeeDto.dateOfBirth" id="dateOfBirth"  data-ng-change="checkAge(employeeDto.dateOfBirth)" required readonly>
                                    </div>
                                    </div>
                                    <i class="fa fa-asterisk" ></i> 
                                     <div data-ng-show="Employee.$submitted || Employee.dateOfBirth.$touched" class="error_msg1">
						             <div data-ng-show="Employee.dateOfBirth.$error.required" class="error_msg1">Please Choose Date Of Birth</div>
					                 </div>
                                  </div>
                                ...
                                <div class="three_column_form_column" data-ng-show="showFather">
                                    <label>Father Name</label>
                                     <input type="text" class="form-control" id="fatherName" name="fatherName" contactman data-ng-model="employeeDto.fatherName" data-ng-required="showFather"   maxlength="20" autocomplete="off">
                                     <i class="fa fa-asterisk" ></i>
                                ...
                                <div class="three_column_form_column" data-ng-show="showHusband">
                                    <label>Husband Name</label>
                                     <input type="text" class="form-control" id="husbandName" name="husbandName" contactman data-ng-model="employeeDto.husbandName"   data-ng-required="showHusband" maxlength="20" autocomplete="off">
                                     <i class="fa fa-asterisk" ></i>
						...
						<div data-ng-show="Employee.department.$error.required" class="error_msg1">Please Select Department</div>
					    </div>
                                </div>
                                <div class="three_column_form_column">
						...
						<div data-ng-show="Employee.designation.$error.required" class="error_msg1">Please Select Designation</div>
					    </div>
                                </div>
                                <div class="three_column_form_column">
                                ...
                                <div class="three_column_form_column">
                                   ...
                                   <div class="input-group date" data-date-format="dd/mm/yyyy" data-date-today-highlight="true" data-date-autoclose="true"  data-date-end-date="0d"  data-provide="datepicker" >
                                            <div class="input-group-addon inner-addon right-addon ">
                                                <i class="fa fa-calendar"></i>
                                                <input type="text" class="form-control" placeholder="" name="confirmationDate" data-ng-model="employeeDto.confirmationDate" id="confirmationDate"  readonly data-ng-change="validateConfirmationDate()">
                                            </div>
                                        </div>
                                </div>
                                <div class="three_column_form_column">
                                    <label>Company Mail Id</label>
                                   <input type="email" class="form-control" id="companyEmailId" name="companyEmailId"  autocomplete="off"    data-ng-model="employeeDto.companyEmailId" maxlength="50" required>
                                   <i class="fa fa-asterisk" ></i>
						          ...
						          <div data-ng-show="Employee.companyEmailId.$error.email" class="error_msg1">Not a valid email</div>
					           </div>
                                </div>
                              <!--   <div class="three_column_form_column">
...
<input type="text" class="form-control" name="subStatus" data-ng-model="employeeDto.subStatus" required data-ng-init="employeeDto.subStatus='WORKING'" readOnly="true">
                                ...
                                <div class="three_column_form_column">
                                   ...
                                   <table style="border:none">
                                   <tr style="border:none">
										<td style="border:none"><input type="radio" data-ng-model="employeeDto.employeeType" required class="with-gap" name="employeeType" id="ONROLL"   value="ONROLL" >
										<label for="ONROLL" >ONROLL</label></td>
										<td style="border:none"><input type="radio" data-ng-model="employeeDto.employeeType"  required class="with-gap" name="employeeType" id="OFFROLL"  value="OFFROLL" >
										<label for="OFFROLL">OFFROLL</label></td>
										<td style="border:none"><i class="fa fa-asterisk" ></i> </td>
										</tr>
										</table>
										<div data-ng-show="Employee.$submitted || Employee.employeeType.$touched" class="error_msg1">
                       ...
                       <div class="new-select-option">
						...
						<div data-ng-show="Employee.proof.$error.required" class="error_msg1">Please choose proof</div>
                                ...
                                <div class="three_column_form_column">
                                 ...
                                 <input type="text" name="aadhaarNumber" id="drivingLicenseNumber" data-ng-model="employeeDto.drivingLicenseNumber" data-ng-minlength="16" alphamumeric data-ng-required="showdrivingLicense" maxlength="16"   class="form-control">
                                 <i class="fa fa-asterisk" ></i>
                                   <div data-ng-if="Employee.$submitted || Employee.aadhaarNumber.$touched" class="error_msg1">
                                 ...
                                 <input type="text" name="aadhaarNumber" id="voterIdNumber" data-ng-model="employeeDto.voterIdNumber"  data-ng-required="showvoterId"  data-ng-minlength="10" alphamumeric maxlength="10"   class="form-control">
                                 <i class="fa fa-asterisk" ></i>
                                  <div data-ng-if="Employee.$submitted || Employee.aadhaarNumber.$touched" class="error_msg1">
                                 ...
                                 <input type="text" name="aadhaarNumber" id="passportNumber" data-ng-model="employeeDto.passportNumber" data-ng-required="showpassportNumber" alphamumeric data-ng-minlength="8" maxlength="8"  class="form-control">
                                 <i class="fa fa-asterisk" ></i>
                                  <div data-ng-if="Employee.$submitted || Employee.aadhaarNumber.$touched" class="error_msg1">
						...
						<div class="new-check-button">
                            ...
                            <div class="row">
                                ...
                                <div class="three_column_form_column">
                                   ...
                                   <input type="email" class="form-control" id="emailId" name="emailId" autocomplete="off"  maxlength="50"  class="email"   data-ng-model="employeeDto.emailId" required>
                                   <i class="fa fa-asterisk" ></i>
                                   <div data-ng-show="Employee.$submitted || Employee.emailId.$touched" class="error_msg1">
						           <div data-ng-show="Employee.emailId.$error.required" class="error_msg1">Please Enter  Email Id</div>
						           <div data-ng-show="Employee.emailId.$error.email" class="error_msg1">Not a valid email</div>
					               </div>
                                </div>
                                <div class="three_column_form_column">
                                    <label>Alternative Mail Id </label>
                                   <input type="email" class="form-control" id="alternateEmailId"  autocomplete="off" name="alternateEmailId"   data-ng-model="employeeDto.alternateEmailId" maxlength="50">
                                  <!--  <i class="fa fa-asterisk" ></i> -->
						           ...
						           <div data-ng-show="Employee.alternateEmailId.$error.email" class="error_msg1">Not a valid email</div>
					              </div>
                                </div>
                            </div>
                            <!-- form 5 -->
                      ...
                      <div class="check_box_event">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="three_column_form_column">
                                 ...
                                 <div class="three_column_form_column">
                                    <label>Address Line 1</label>
                                    <input type="text" class="form-control" id="paddress1" name="paddress1" data-ng-model="employeeDto.paddress1" data-ng-readonly="read" required>
                                    <i class="fa fa-asterisk" ></i>
								...
								<select name="pstate" id="pstate"
									data-ng-model="employeeDto.pstate" data-ng-disabled="read"
							...
							<i class="fa fa-asterisk" ></i>
								...
								<select name="pcity" id="pcity"
									data-ng-model="employeeDto.pcity" data-ng-disabled="read"
									required class="select2 form-control"
									style="width: 100%; height: 36px;" >
									<option value="" selected></option> 
									<option
