				...
				<form class="form-inline" method="post" name="new_wareHouse" id="new_wareHouse" novalidate>
					<div class="col-md-6 col_md text-center">
						<div class="add_icon_asterisk">
							<label for="email">WareHouse Name:</label> <input type="text"
								...
								data-ng-init="wareHouseDto.wareHouseName='${wareHouseDto.wareHouseName}'" maxlength="50" required tabindex="1">
						...
						<div class="add_icon_asterisk">
							...
							<input type="text" class="form-control" id="code" name="code"
								...
								ng-init="wareHouseDto.code='${wareHouseDto.code}'" required tabindex="2">
								<i class="fa fa-asterisk" ></i>
						</div>
						...
						<div class="add_icon_asterisk">
							<label for="pwd">Parent Code:</label> <input type="text"
								...
								ng-init="wareHouseDto.parentCode='${wareHouseDto.parentCode}'" readonly tabindex="3">
								<i class="fa fa-asterisk" ></i>
						</div>
						<div
						...
						<div class="add_icon_asterisk">
							<label for="pwd">Address 1 :
								...
								data-ng-init="wareHouseDto.address1='${wareHouseDto.address1}'" maxlength="50" required tabindex="4">
								<i class="fa fa-asterisk" ></i>
						</div>
						<div
						...
						<div class="">
							<label for="pwd"> Address 2:</label> <input type="text"
								...
								ng-init="wareHouseDto.address2='${wareHouseDto.address2}'" maxlength="50" tabindex="5">
						</div>
						<div class="">
							<label for="pwd"> Address 3:</label> <input type="text"
								...
								ng-init="wareHouseDto.address3='${wareHouseDto.address3}'" maxlength="50" tabindex="6">
						</div>
						<div class="">
							<label for="pwd"> Area / Landmark:</label> <input type="text"
								...
								ng-init="wareHouseDto.areaLandmark='${wareHouseDto.areaLandmark}'" maxlength="50" tabindex="7">
						</div>
					</div>
					<div class="col-md-6 col_md text-center">
						...
						<input list="country" class="form-control" id="country_List" name="country"
							...
							data-ng-model="wareHouseDto.country" ng-blur="getStates(wareHouseDto.country);" ng-init="wareHouseDto.country='${wareHouseDto.country}'" autocomplete="off" tabindex="8">
							<i class="fa fa-asterisk" ></i>
						<datalist id="country">
					...
					<div
						...
						<label for="pwd">State</label> <input list="state"
							...
							data-ng-blur="getCity(wareHouseDto.state,wareHouseDto.country)"  tabindex="9" data-ng-init="wareHouseDto.state='${wareHouseDto.state}'" autocomplete="off">
								<i class="fa fa-asterisk" ></i>
						<datalist id="state">
						...
						<label for="pwd">City Name</label> <input list="city"
							...
							data-ng-model="wareHouseDto.city" autocomplete="off" tabindex="10">
							<i class="fa fa-asterisk" ></i>
						<datalist id="city" >
					...
					<div
						...
						<div class="add_icon_asterisk">
							...
							<input type="text" class="form-control" id="pinCode" name="pinCode"
								...
								ng-init="wareHouseDto.pinCode='${wareHouseDto.pinCode}'" required tabindex="11">
								<i class="fa fa-asterisk" ></i>
						</div>
						<div class="add_icon_asterisk">
							<label for="pwd">Effective Start Date:</label> 
										...
										<div class="input-group date" data-date-format="dd/mm/yyyy" data-date-today-highlight="true" data-date-autoclose="true" data-provide="datepicker">
                                            <div class="input-group-addon inner-addon right-addon ">
                                                ...
                                                <input type="text" class="form-control" placeholder=""  tabindex="12" id="effectiveStartDate" name="effectiveStartDate" data-ng-model="wareHouseDto.effectiveStartDate" ng-init="wareHouseDto.effectiveStartDate='${wareHouseDto.effectiveStartDate}'" readonly required>
						...
						<div class="add_icon_asterisk">
							<label for="pwd">Effective End Date:</label> 
										...
										<div class="input-group date" data-date-format="dd/mm/yyyy" data-date-today-highlight="true" data-date-autoclose="true" data-provide="datepicker">
                                            <div class="input-group-addon inner-addon right-addon ">
                                                <i class="fa fa-calendar"></i>
                                                <input type="text" class="form-control" placeholder=""  tabindex="13" id="effectiveEndDate" data-ng-change="validateToDate()" name="effectiveEndDate" data-ng-model="wareHouseDto.effectiveEndDate" ng-init="wareHouseDto.effectiveEndDate='${wareHouseDto.effectiveEndDate}'" readonly required>
                                                                                            </div>
                                        </div>
                                        <i class="fa fa-asterisk" ></i>							
						</div>
					...
					<div
						...
						<div class="new-radio-button-inline">
										<input type="radio" data-ng-model="wareHouseDto.status" tabindex="14" ng-init="wareHouseDto.status='${wareHouseDto.status}'" required class="with-gap" name="status" id="ACTIVE" value="ACTIVE" >
										<label for="ACTIVE" >ACTIVE</label>
										<input type="radio" data-ng-model="wareHouseDto.status"  tabindex="15" ng-init="wareHouseDto.status='${wareHouseDto.status}'" required class="with-gap" name="status" id="INACTIVE" value="INACTIVE" >
