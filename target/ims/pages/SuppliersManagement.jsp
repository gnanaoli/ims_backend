			...
			Please Enter Fax No with Fax Std Code
					...
					<div class="">
						<label for="pwd"> E-Mail Id:</label> <input type="email"
							 id="emailId" name="emailId" data-ng-pattern="emailFormat" class="email" 
							data-ng-model="supplierDto.emailId" autocomplete="off"
							tabindex="22" maxlength="50">
					</div>
					<div
					...
					<div class="add_icon_asterisk">
						<label for="pwd"> GST IN:</label> <input type="text"
							...
							autocomplete="off" tabindex="23" required data-ng-minlength="15"  maxlength="15" gstinvalid capitalize nospecialchar>
							<i class="fa fa-asterisk" ></i>
					</div>
					<div
				...
				<div class="col-12 submit_col text-center">
					<button class="btn btn-primary" tabindex="26"
						data-ng-click="saveSupplier($event,add_supplier)">
						<i class="fa fa-check"></i> SAVE
					</button>
					<span class="btn btn-warning" data-ng-click="cancel()" tabindex="27">
