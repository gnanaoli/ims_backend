					...
					<tbody>
						<tr data-ng-repeat="projectDto in projectDtoList">
							...
							<!-- </div> -->
							 ...
							 <security:authorize access="hasAuthority('OFFICE ADMINISTRATOR') or hasAuthority('SUPER USER') or hasAuthority('USER')">
							...
							<div class="form-content create_form">
								...
								<form class="form-inline" role="form" name="new_project" id="new_project" novalidate>
									...
									<div class="col-md-6 col_md text-center">
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="taskName" name="taskName" allowspace data-ng-model="projectsTaskDto.taskName" maxlength="100"  required="required" class="error_msg" autocomplete="off" tabindex="1">
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy" data-date-today-highlight="true" data-date-autoclose="true" data-provide="datepicker">
									...
									<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="comments" name="comments" addressvalid data-ng-model="projectsTaskDto.comments" maxlength="100"  required="required" class="error_msg" autocomplete="off" tabindex="7">
											<i class="fa fa-asterisk" ></i>
										</div>
									...
									<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="status" name="status" onlystring data-ng-model="projectsTaskDto.status" maxlength="16"  required="required" class="error_msg" autocomplete="off" tabindex="8">
											<i class="fa fa-asterisk" ></i>
										</div>
							...
							<div class="form-content create_form">
								...
								<form class="form-inline" role="form" name="new_project" id="new_project" novalidate>
									...
									<div class="add_icon_asterisk">
                                        ...
                                        <i class="fa fa-asterisk" ></i>
																															<div data-ng-show="new_project.$submitted || new_project.startDate.$touched" class="error_msg">
									<div data-ng-show="new_project.startDate.$error.required" class="error_msg">Please Enter Resource Count </div>
									</div>	
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy" data-date-today-highlight="true" data-date-autoclose="true" data-provide="datepicker">
                                          ...
                                          <i class="fa fa-asterisk" ></i>
																					<!--<div data-ng-show="new_project.$submitted || new_project.endDate.$touched" class="error_msg">
									<div data-ng-show="new_project.endDate.$error.required" class="error_msg">Please Enter Resource Count </div>
									</div> -->
									...
									<div class="add_icon_asterisk">
											<label for="pwd">Comments:</label>
											<input type="text" class="form-control" id="comments" name="comments" addressvalid data-ng-model="projectsTaskDto.comments" maxlength="100"  required="required" class="error_msg" autocomplete="off" tabindex="6">
											<i class="fa fa-asterisk" ></i>
										</div>
										<div data-ng-show="new_project.$submitted || new_project.comments.$touched" class="error_msg">
									<div data-ng-show="new_project.comments.$error.required" class="error_msg">Please Enter Comments </div>
									...
									<div class="add_icon_asterisk">
											<label for="pwd">Status:</label>
											<input type="text" class="form-control" id="status" name="status" onlystring data-ng-model="projectsTaskDto.status" maxlength="16"  required="required" class="error_msg" autocomplete="off" tabindex="7">
											<i class="fa fa-asterisk" ></i>
										</div>
										<div data-ng-show="new_project.$submitted || new_project.status.$touched" class="error_msg">
									<div data-ng-show="new_project.status.$error.required" class="error_msg">Please Enter Status </div>
