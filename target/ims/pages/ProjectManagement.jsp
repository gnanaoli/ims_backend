...
<div class="container-fluid user-top"
	data-ng-controller="projectManagementController">
	<!-- ============================================================== -->
						...
						<tbody>
							<tr data-ng-repeat="projectDto in projectDtoList">
								...
								<td class="table_btn_group"><security:authorize
										...
										<a href="" data-ng-click="edit(projectDto)"
											class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
									</security:authorize> <a href="" data-ng-click="view(projectDto)"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-bordered table-striped">
						...
						<tr>
							<th>Project In Charge</th>
							<td>{{projectDetails.projectInCharge}}</td>
						</tr>
						<tr>
							<th>Start Date</th>
							<td>{{projectDetails.startDate}}</td>
						</tr>
						<tr>
							<th>End Date</th>
							<td>{{projectDetails.endDate}}</td>
						</tr>
						<tr>
							<th>Status</th>
	...
	<div data-ng-if="newProject">
		<div class="form_section">
			<div class="form-content create_form">
				...
				<form class="form-inline" role="form" name="new_project"
					id="new_project" data-ng-submit="saveProject(new_project.$valid)"
					novalidate>
					<div class="row">
						<div class="col-md-6 col_md text-center">

							<div class="add_icon_asterisk">
								<label for="pwd">Project Name:</label> <input type="text"
									class="form-control" id="name" name="name" allowspacealphanum
									data-ng-model="projectDto.name" maxlength="50"
									required="required" class="error_msg" autocomplete="off"
									tabindex="1"> <i class="fa fa-asterisk"></i>
							</div>
							<div
								data-ng-show="new_project.$submitted || new_project.name.$touched"
								class="error_msg">
								<div data-ng-show="new_project.name.$error.required"
									class="error_msg">Please Enter Project Name</div>
							</div>
							<div class="">
								<label for="pwd">In Charge Name:</label> <input type="text"
									class="form-control" id="projectInCharge"
									name="projectInCharge" 
									data-ng-model="projectDto.projectInCharge" maxlength="100"
									contactman class="error_msg" autocomplete="off" tabindex="2">
							...
							<div class="add_icon_asterisk">
								...
								<div class="new-select-option">
									<select name="projectType" id="" wb-select2
										data-ng-model="projectDto.projectType" required
							...
							<div
								data-ng-show="new_project.$submitted || new_project.projectType.$touched"
								class="error_msg">
								<div data-ng-show="new_project.projectType.$error.required"
									class="error_msg">Please Select Project Type</div>
							</div>
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy"
									...
									<div class="input-group-addon inner-addon right-addon ">
										<i class="fa fa-calendar"></i> <input type="text"
											...
											id="startDate" data-ng-model="projectDto.startDate" readonly
											required tabindex="4" data-ng-change="validateEndDate()">
							...
							<div
								data-ng-show="new_project.$submitted || new_project.startDate.$touched"
								class="error_msg">
								<div data-ng-show="new_project.startDate.$error.required"
									class="error_msg">Please Select Start Date</div>
							</div>
							<div class="add_icon_asterisk">
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy"
									...
									<div class="input-group-addon inner-addon right-addon ">
										<i class="fa fa-calendar"></i> <input type="text"
											...
											id="endDate" data-ng-model="projectDto.endDate" readonly
											required tabindex="5" data-ng-change="validateEndDate()">
							...
							<div
								data-ng-show="new_project.$submitted || new_project.endDate.$touched"
								class="error_msg">
								<div data-ng-show="new_project.endDate.$error.required"
									class="error_msg">Please Select End Date Should Not Be Greater Than Start Date</div>
							</div>
							...
							<div class="add_icon_asterisk">
								<label for="pwd">Address 1 :</label> <input type="text"
									...
									data-ng-model="projectDto.address1" maxlength="50"
									required="required" class="error_msg" tabindex="6"> <i
									class="fa fa-asterisk"></i>
							</div>
							<div
								data-ng-show="new_project.$submitted || new_project.address1.$touched"
								class="error_msg">
								<div data-ng-show="new_project.address1.$error.required"
							...
							<div class="">
								<label for="pwd"> Address 2:</label> <input type="text"
									...
									data-ng-model="projectDto.address2" maxlength="50" tabindex="7">
							</div>
						</div>
						<div class="col-md-6 col_md text-center">
							...
							<div class="">
								<label for="pwd"> Address 3:</label> <input type="text"
									class="form-control" id="address3" name="address3" addressvalid
									data-ng-model="projectDto.address3" maxlength="50" tabindex="8">
							</div>


							<div class="">
								<label for="pwd"> Area / Landmark:</label> <input type="text"
									class="form-control" id="areaLandmark" name="areaLandmark" addressvalid
									data-ng-model="projectDto.areaLandmark" maxlength="50"
									tabindex="9">
							</div>
							...
							<div
								data-ng-show="new_project.$submitted ||new_project.state.$touched"
								class="error_msg">
								<div data-ng-show="new_project.state.$error.required"
						...
						<label for="pwd">City Name</label> -->
								...
								<div class="new-select-option">
									<select name="city" id="city" wb-select2
										data-ng-model="projectDto.city" required class="form-control"
							...
							<div
								data-ng-show="new_project.$submitted || new_project.city.$touched"
								class="error_msg">
								<div data-ng-show="new_project.city.$error.required"
							...
							<%-- <div class="add_icon_asterisk">
								<label for="email">Pin Code:</label> <input type="text"
									...
									data-ng-model="projectDto.pinCode" required maxlength="6"
									numbersonly tabindex="13"> <i class="fa fa-asterisk"></i>
							</div>
							<div
								data-ng-show="new_project.$submitted || new_project.pinCode.$touched"
								class="error_msg">
								<div data-ng-show="new_project.pinCode.$error.required"
									class="error_msg">Please enter Pin code</div>
								<div data-ng-show="new_project.pinCode.toString().length<7">Please
									enter Valid 6 digit Pin Code</div>
							</div> --%>
							
							<div class="add_icon_asterisk">
												<label for="email">Pin Code:</label>
												<input type="text" class="form-control" id="pinCode" name="pinCode" data-ng-model="projectDto.pinCode" maxlength='6' data-ng-maxlength="6"  data-ng-minlength="6" numbersonly required autocomplete="off" tabindex="13" >
												<i class="fa fa-asterisk" ></i>
											</div>
								<div class="error_msg" data-ng-show="new_project.$submitted || new_project.pinCode.$touched" >		

 					<div class="error_msg"  data-ng-show="new_project.pinCode.$error.minlength">Please Enter 6 Digit Pincode</div>
                  	<div class="error_msg"  data-ng-show="new_project.pinCode.$error.maxlength"  >Please Enter 6 Digit  Pincode</div> 								
                   <div  class="error_msg" data-ng-show="new_project.pinCode.$error.required">Please Enter  Pincode</div>
                  </div>
							...
							<div class="add_icon_asterisk">
								...
								<div class="new-select-option">
									<select name="status" id="status" wb-select2
										data-ng-model="projectDto.status" required
										class="form-control" style="width: 100%; height: 36px;"
										tabindex="14">
							...
							<div
								data-ng-show="new_project.$submitted || new_project.status.$touched"
								class="error_msg">
								<div data-ng-show="new_project.status.$error.required"
						...
						<div class="col-12 submit_col text-center">
							<button class="btn btn-primary" data-ng-click="saveProject()">
	...
	<div data-ng-if="editProject">
		<div class="form_section">
			<div class="form-content create_form">
				...
				<form class="form-inline" role="form" name="edit_project"
					id="edit_project" data-ng-submit="saveProject(edit_project.$valid)"
					novalidate>
					<div class="row">
						<div class="col-md-6 col_md text-center">

							<input type="hidden" class="form-control" id="id" name="id"
								data-ng-model="projectDto.id">
							<div class="add_icon_asterisk">
								<label for="pwd">Project Name:</label> <input type="text" allowspacealphanum
									class="form-control" id="name" name="name"
									data-ng-model="projectDto.name" maxlength="50"
									required="required" autocomplete="off" tabindex="1"> <i
									class="fa fa-asterisk"></i>
							</div>
							<div
								data-ng-show="edit_project.$submitted || edit_project.name.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.name.$error.required"
									class="error_msg">Please Enter Project Name</div>
							</div>
							...
							<div
								data-ng-show="edit_project.$submitted || edit_project.projectType.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.projectType.$error.required"
									class="error_msg">Please Select project Type</div>
							</div>
							...
							<div class="">
								<label for="pwd">In charge Name:</label> <input type="text"
									class="form-control" id="projectInCharge"
									name="projectInCharge" contactman
									data-ng-model="projectDto.projectInCharge" autocomplete="off"
									tabindex="3">
								<!-- <i class="fa fa-asterisk" ></i> -->
							</div>
							...
							<div class="add_icon_asterisk">
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy"
									...
									<div class="input-group-addon inner-addon right-addon ">
										<i class="fa fa-calendar"></i> <input type="text"
											class="form-control" placeholder="" name="startDate"
											id="startDate" data-ng-model="projectDto.startDate"
											data-ng-change="validateEndDate()" readonly required
											autocomplete="off" tabindex="4">

									</div>
									<div
										data-ng-show="edit_project.$submitted || edit_project.startDate.$touched"
										class="error_msg">
										<div data-ng-show="edit_project.startDate.$error.required"
											class="error_msg">Please Select Start Date</div>
									</div>
								</div>
								<i class="fa fa-asterisk"></i>
							...
							<div class="add_icon_asterisk">
								...
								<div class="input-group date" data-date-format="dd/mm/yyyy"
									...
									<div class="input-group-addon inner-addon right-addon ">
										<i class="fa fa-calendar"></i> <input type="text"
											class="form-control" placeholder="" name="endDate"
											id="endDate" data-ng-model="projectDto.endDate"
											data-ng-change="validateEndDate()" readonly required
								...
								<div
									data-ng-show="edit_project.$submitted || edit_project.endDate.$touched"
									class="error_msg">
									<div data-ng-show="edit_project.endDate.$error.required"
										class="error_msg">Please Select End Date Should Not Be Greater Than Start Date</div>
								</div>
							...
							<div class="add_icon_asterisk">
								<label for="pwd">Address 1 :</label> <input type="text"
									class="form-control" id="address1" name="address1" addressvalid
									data-ng-model="projectDto.address1" required="required"
									autocomplete="off" tabindex="6"> <i
									class="fa fa-asterisk"></i>
							</div>

							<div
								data-ng-show="edit_project.$submitted || edit_project.address1.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.address1.$error.required"
									class="error_msg">Please enter Address1</div>
							</div>
							...
							<div class="">
								<label for="pwd"> Address 2:</label> <input type="text"
									class="form-control" id="address2" name="address2" addressvalid
									data-ng-model="projectDto.address2" autocomplete="off"
									tabindex="7">
							</div>
						</div>
						<div class="col-md-6 col_md text-center">
							...
							<div class="">
								<label for="pwd"> Address 3:</label> <input type="text"
									class="form-control" id="address3" name="address3" addressvalid
									data-ng-model="projectDto.address3" autocomplete="off"
									tabindex="8">
							</div>
							...
							<div class="">
								<label for="pwd"> Area / Landmark:</label> <input type="text"
									class="form-control" id="areaLandmark" name="areaLandmark" addressvalid
									data-ng-model="projectDto.areaLandmark" autocomplete="off"
									tabindex="9">
							</div>
							...
							<div
								data-ng-show="edit_project.$submitted ||edit_project.state.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.state.$error.required"
									class="error_msg">Please Select State</div>
							</div>
							...
							<div
								data-ng-show="edit_project.$submitted || edit_project.city.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.city.$error.required"
									class="error_msg">Please Select City</div>
							</div>
							<div class="add_icon_asterisk">
								<label for="email">Pin Code:</label> <input type="text"
									class="form-control" id="pinCode" name="pinCode"
									data-ng-model="projectDto.pinCode" required="required" maxlength="6"
									autocomplete="off" numbersonly tabindex="13"> <i
									class="fa fa-asterisk"></i>
							</div>
							<div
								data-ng-show="edit_project.$submitted || edit_project.pinCode.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.pinCode.$error.required"
									class="error_msg">Please enter Pin code</div>
								<div data-ng-show="edit_project.pinCode.toString().length<7">Please
									enter Valid 6 digit Pin Code</div>
							</div>
							<%-- <div class="add_icon_asterisk">
											<label for="email">Status </label>
							...
							<div
								data-ng-show="edit_project.$submitted || edit_project.status.$touched"
								class="error_msg">
								<div data-ng-show="edit_project.status.$error.required"
									class="error_msg">Please Select Status</div>
