		...
		<div class="form-content create_form">
			...
			<div class="row">
				...
				<div class="add_icon_asterisk">
						...
						<div data-ng-show="NewUser.$submitted || NewUser.empid.$touched" class="error_msg">
						<div data-ng-show="NewUser.empid.$error.required" class="error_msg">Please choose employeeId</div>
					    </div>
					</div>
					<!-- <div class="add_icon_asterisk"> -->
					<div class="">
						<label for="email">Name</label> <input type="text"
							...
							data-ng-model="userDto.name"  readonly="readonly" autocomplete="off" >
					...
					<div class="add_icon_asterisk">
						<label for="email">User Name</label> <input type="text" 
							class="normalstring" id="userName" name="userName" usernameonly
							data-ng-model="userDto.userName" required autocomplete="off" maxlength="20">
							<i class="fa fa-asterisk" ></i>
					</div>
					
					<div data-ng-show="NewUser.$submitted || NewUser.userName.$touched" class="error_msg">
					...
					<div class="add_icon_asterisk">
						<label for="pwd">Password</label> <input type="text"
							class="normalstring" id="password" name="password" passwordvalidation
						disallow-spaces	data-ng-model="userDto.password" required autocomplete="off" maxlength="20">
							<i class="fa fa-asterisk" ></i>
					</div>
					...
					<div class="add_icon_asterisk">
						<label for="pwd">Confirm Password</label> <input type="text"
							class="normalstring" id="confirmPassword" name="confirmPassword" passwordvalidation
							disallow-spaces data-ng-model="userDto.confirmPassword" required autocomplete="off" maxlength="20">
							<i class="fa fa-asterisk" ></i>
					</div>
