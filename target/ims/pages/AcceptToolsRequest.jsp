		...
		<div class="form-content create_form">
			...
			<form class="form-inline" name="acceptTools" id="acceptTools"
				...
				<div class="col-md-6 col_md text-center">
					...
					<div class="add_icon_asterisk">
						<label for="pwd">Sub Category Name :</label> <input type="text"
					...
					<div class="add_icon_asterisk">
						...
						<security:authorize access="hasAuthority('USER') or hasAuthority('SUPER USER')">
							<c:choose>
								<c:when test="${inventoryRequestDto.location == 'ALL'}">
								<div class="add_icon_asterisk">
				...
				<div class="col-md-6 col_md text-center">
					...
					<div class="add_icon_asterisk">
						<label for="pwd"> Quantity:</label> <input type="text"
							class="form-control" id="quantity" name="quantity" numbersonly required
							...
							<i class="fa fa-asterisk" ></i>
					<div
						data-ng-show="acceptTools.$submitted || acceptTools.quantity.$touched" class="error_msg">
						<div data-ng-show="acceptTools.quantity.$error.required" class="error_msg">Please
							Enter Quantity</div>
					</div>							
					</div>
