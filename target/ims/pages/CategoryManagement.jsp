								...
								<form class="form-inline"  method="post" role="form" name="new_category" id="new_category" novalidate >
									<div class="col-md-6 col_md text-center">
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="categoryType" name="categoryType" allowspace data-ng-model="categoryDto.categoryType" required="required" maxlength="50" tabindex="1" autocomplete="off">
									...
									<div data-ng-show="new_category.categoryType.$error.required" class="error_msg">Please Enter Category Type</div>
										...
										<div class="add_icon_asterisk">
											...
											<input type="text" class="form-control" id="categoryCode" name="categoryCode" alphamumeric data-ng-model="categoryDto.categoryCode" required="required" maxlength="6" tabindex="2" autocomplete="off">
											<i class="fa fa-asterisk" ></i>
										</div>
										
										<div data-ng-show="new_category.$submitted || new_category.categoryCode.$touched" class="error_msg">
									<div data-ng-show="new_category.categoryCode.$error.required" class="error_msg">Please Enter Category Code</div>
									</div>	
							...
							<div class="form-content create_form">
								...
								<form class="form-inline"  method="post" role="form" name="editcategory" id ="editcategory"  novalidate >
									<div class="col-md-6 col_md text-center">
										<div class="add_icon_asterisk">
											<label for="email">Category Type:</label> 
											<input type="text" class="form-control" id="categoryType1" name="categoryType" allowspace data-ng-model="categoryDto.categoryType" maxlength="50" autocomplete="off" required="required" tabindex="1" >
											<i class="fa fa-asterisk" ></i>
									...
									<div data-ng-show="editcategory.categoryType.$error.required" class="error_msg">Please Enter Category Type</div>
										...
										<div class="add_icon_asterisk">
											<label for="pwd">Category Code:</label>
											<input type="text" class="form-control" id="categoryCode1" name="categoryCode" alphamumeric data-ng-model="categoryDto.categoryCode"  maxlength="6" autocomplete="off" required="required" tabindex="2">
											<i class="fa fa-asterisk" ></i>
										</div>
										<div data-ng-show="editcategory.$submitted || editcategory.categoryCode.$touched" class="error_msg">
									<div data-ng-show="editcategory.categoryCode.$error.required" class="error_msg">Please Enter Category Code</div>
									</div>
									<div class="">
